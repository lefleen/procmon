...
class UsingCpuProc
{
	...
	Result get_time_using_cpu(const descriptor_process_t& descriptor_process, ULARGE_INTEGER& time_using_cpu);
	...
	Result update(ProcessDescriptorRAII& descriptor_process);
public:
