...
*Implemented as two separate namespaces, one for each OS.*
...
*Implemented as a separate file; it does not contain classes or namespaces.*
...
*Implemented as a separate file; it does not contain classes or namespaces and includes only one structure.*
...
It contains functional blocks for file operations for loading and saving procmon config and process data files.

## ParseUtility

*Implemented as a namespace.*

It contains functional blocks for parsing: command line and procmon config data from file. It also serializes config data into strings for saving.

## UpdateUtility

*Implemented as a namespace.*

It contains functional blocks for updating process data and procmon config and prepares data for saving to a file.

## UserInterface

*Implemented as a namespace.*

It contains functional blocks for printing information about errors, warnings, help, and other information for the user.

## Settings

*Implemented as a namespace.*

It contains functional blocks for binding settings with table and structures for storing settings state.
